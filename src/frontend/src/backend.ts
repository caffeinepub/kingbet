...
export class Backend implements backendInterface {
    ...
    async createMarket(arg0: string, arg1: string, arg2: Array<string>, arg3: Array<Array<bigint>>): Promise<MarketId> {
        if (this.processError) {
            try {
                const result = await this.actor.createMarket(arg0, arg1, arg2, arg3);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async placeBet(arg0: MarketId, arg1: bigint, arg2: bigint, arg3: bigint, arg4: boolean): Promise<void> {
        if (this.processError) {
            try {
    ...
    async updateBalance(arg0: Principal, arg1: bigint): Promise<void> {
        if (this.processError) {
            try {
    ...
    async updateMarket(arg0: MarketId, arg1: string): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.updateMarket(arg0, arg1);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
