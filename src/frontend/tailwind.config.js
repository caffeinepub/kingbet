  ...
  theme: {
    ...
    extend: {
      ...
      colors: {
        ...
        back: {
          DEFAULT: "oklch(var(--back))",
          foreground: "oklch(var(--back-foreground))",
          hover: "oklch(var(--back-hover))",
        },
        lay: {
          DEFAULT: "oklch(var(--lay))",
          foreground: "oklch(var(--lay-foreground))",
          hover: "oklch(var(--lay-hover))",
        },
        gold: {
